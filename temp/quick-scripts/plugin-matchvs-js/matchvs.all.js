...
(function e(t, n, r) {
    ...
    1: [function (_require, module, exports) {
        ...
        proto.stream.GetRoomListExRsp.prototype.getRoominfoexList = function () {
            return (/** @type{!Array.<!proto.stream.RoomInfoEx>} */jspb.Message.getRepeatedWrapperField(this, proto.stream.RoomInfoEx, 3)
            );
        };
        ...
        proto.stream.GetRoomDetailRsp.prototype.getRoomdetail = function () {
            return (/** @type{?proto.stream.RoomDetail} */jspb.Message.getWrapperField(this, proto.stream.RoomDetail, 2)
            );
        };
        ...
        proto.stream.RoomDetail.prototype.getPlayerinfosList = function () {
            return (/** @type{!Array.<!proto.stream.PlayerInfo>} */jspb.Message.getRepeatedWrapperField(this, proto.stream.PlayerInfo, 9)
            );
        };
...
function MatchvsEngine() {
        ...
        this.onMsg = function (dataView) {
            ...
            switch (packet.header.cmd) {
                ...
                case MATCHVS_NETWORK_STATE_NOTIFY:
                    engine.mRsp.networkStateNotify && engine.mRsp.networkStateNotify(new MsNetworkStateNotify(packet.payload.getRoomid(), packet.payload.getUserid(), packet.payload.getState(), packet.payload.getOwner()));
                    break;
    ...
    this.joinRoomWithProperties = function (matchinfo, userProfile) {
        ...
        if (ret !== 0) return ret;
        if (userProfile.length > 512) return -21;
        if ((typeof matchinfo === "undefined" ? "undefined" : _typeof(matchinfo)) !== "object") return -1;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=matchvs.all.js.map
